...
Output only the new translation and nothing else."""
    ...
    translation_2 = get_completion(prompt, system_message, model)

    return translation_2


def one_chunk_translate_text(
    source_lang: str, target_lang: str, source_text: str, country: str = "", model: str = "gemini-pro"
) -> str:
    """
...
def multichunk_initial_translation(
    source_lang: str, target_lang: str, source_text_chunks: List[str], model: str = "gemini-pro"
) -> List[str]:
    """
...
def multichunk_translation(
    source_lang, target_lang, source_text_chunks, country: str = "", model: str = "gemini-pro"
):
    """
