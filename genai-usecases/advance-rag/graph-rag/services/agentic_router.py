...
class AgenticRetrieverRouter:
    ...
    def _analyze_query(self, state: RouterState) -> RouterState:
        ...
        try:
            ...
            analysis = message_text(response) if hasattr(response, 'content') else str(response)
    ...
    def _select_strategy(self, state: RouterState) -> RouterState:
        ...
        try:
            ...
            response_text = message_text(response) if hasattr(response, 'content') else str(response)
