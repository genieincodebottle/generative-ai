...
from services.agentic_router import create_agentic_router
...
def require_api_key() -> str:
    """Check for the key at the point of use, not at import time.

    This module used to raise at import if GOOGLE_API_KEY was unset, which
    meant the API could not even start to report the problem, and no test
    could import the module without a real key. Checking here keeps the
    failure informative and keeps the module importable.
    """
...
class GraphRAGSystem:
    ...
    def _initialize_components(self):
        # Checked here rather than at import: the API needs to be able to
        # start and report a missing key, not die while loading a module.
        require_api_key()
